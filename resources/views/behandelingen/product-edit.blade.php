        ...
        <form method="POST" action="{{ route('behandelingen.producten.update', [$behandelingId, $product->Id]) }}" class="max-w-4xl rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $product->Opmerking }}" readonly class="block w-full cursor-not-allowed rounded-xl border-zinc-300 bg-zinc-100 px-4 py-2.5 text-zinc-500 shadow-sm dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400">
                </div>
            </div>
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                ...
                <a href="{{ route('behandelingen.producten.show', [$behandelingId, $product->Id]) }}" class="inline-flex items-center rounded-xl bg-zinc-500 px-4 py-2 text-sm font-medium text-white transition hover:bg-zinc-600">
                    Terug
                </a>
            </div>
        </form>
