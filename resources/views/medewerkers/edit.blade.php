<x-layouts::app :title="$title">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-4 sm:p-6 lg:p-8">
        ...
        <form method="POST" action="{{ route('medewerkers.update', $medewerker->Id) }}"
            class="max-w-4xl rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="naam" name="naam"
                        value="{{ old('naam', $medewerker->VolledigeNaam) }}" required
                ...
                <div>
                    ...
                    <input type="email" id="contact_email" name="contact_email"
                        value="{{ old('contact_email', $medewerker->ContactEmail) }}" required
                        class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>

                <div>
                    <label class="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-200">Account
                        e-mail</label>
                    <input type="text" value="{{ $medewerker->AccountEmail }}" readonly
                        class="block w-full cursor-not-allowed rounded-xl border-zinc-300 bg-zinc-100 px-4 py-2.5 text-zinc-500 shadow-sm dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="straatnaam" name="straatnaam"
                        value="{{ old('straatnaam', $medewerker->Straatnaam) }}" required
                        class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 sm:col-span-2 sm:grid-cols-3">
                    <div>
                        ...
                        <input type="number" min="1" id="huisnummer" name="huisnummer"
                            value="{{ old('huisnummer', $medewerker->Huisnummer) }}" required
                            class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                    </div>

                    <div>
                        <label for="toevoeging"
                            class="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-200">Toevoeging</label>
                    ...
                    <div>
                        ...
                        <input type="text" id="postcode" name="postcode"
                            value="{{ old('postcode', $medewerker->Postcode) }}" required
                            class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                        @error('postcode')
                            <p class="mt-1 text-sm text-rose-600">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <input type="text" id="plaats" name="plaats"
                        value="{{ old('plaats', $medewerker->Plaats) }}" required
                        class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="mobiel" name="mobiel"
                        value="{{ old('mobiel', $medewerker->Mobiel) }}" required
                        class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                    @error('mobiel')
                        <p class="mt-1 text-sm text-rose-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="sm:col-span-2">
                    <label for="opmerking"
                        class="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-200">Opmerking</label>
